      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            FutureBuilder<List<Tuple2<DateTime, String>>>(
                ...
                if (snapshot.hasData) {
                  return SettingsCard(
                    ...
                    child: MenuAnchorWidget(
                      ...
                      buttonText: preferencesNotifier.value
                          .preferences['campus'] ?? '',
                      onPressed: () {},
                    ),
                  );
                ...
                if (snapshot.hasData) {
                  return SettingsCard(
                    ...
                    child: ElevatedButton(
                      style: ButtonStyle(
                        backgroundColor: WidgetStateProperty.all<Color>(Theme
                            .of(context)
                            .colorScheme
                            .surfaceBright),
                        shadowColor: WidgetStateProperty.all<Color>(Theme
                            .of(context)
                            .colorScheme
                            .shadow),
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(updateAvailable ? AppLocalizations.of(context)
                              .translate('update.update') : snapshot.data
